...
- `--stage triangle|texture|transform|lighting`: triangleからtexture付きquad、MVP cube、depth/culling/lightへ段階的に進む
...
- `TriangleRenderer.cs`: stage別mesh、texture/sampler、MVP、depth/culling/light、command recording、readback framebuffer
