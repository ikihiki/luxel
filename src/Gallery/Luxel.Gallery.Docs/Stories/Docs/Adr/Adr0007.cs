...
{
    [Story]
    public static StoryResult Adr0007(StoryContext ctx) => $$"""
        ...
        新スタックの補完ポップアップ ([ADR-0006](story:Internals/ADR/Adr0006) の S6c) を機に、**全ての浮遊 UI が同じ規則で端に反応する**土台を作りたい、という力学です。
        ...
        - **IME 候補ウインドウ** ([ADR-0008](story:Internals/ADR/Adr0008)) も、自前描画する場合はこの Popup として CaretRect にアンカーする — 浮遊 UI の一消費者になる
