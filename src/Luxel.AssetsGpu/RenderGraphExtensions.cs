...
/// <summary>
/// Luxel.RenderGraph と Resources の橋渡し (RGRE-M1/M2)。
...
public static class RenderGraphExtensions
{
    ...
    public static TextureHandle ImportTexture(this RenderGraph.RenderGraph rg, ResourceHandle<GpuTexture> handle, string? name = null)
    {
    ...
    public static BufferHandle ImportBuffer(this RenderGraph.RenderGraph rg, ResourceHandle<GpuBuffer> handle, string? name = null)
    {
        ArgumentNullException.ThrowIfNull(handle);
        if (!handle.IsReady || handle.Value is null)
    ...
    public static TextureHandle ImportRenderTarget(this RenderGraph.RenderGraph rg, RenderTarget target, string name = "renderTarget")
    {
    ...
    public static BufferHandle ImportRenderBuffer<T>(this RenderGraph.RenderGraph rg, RenderBuffer<T> buffer, string name = "renderBuffer") where T : unmanaged
    {
