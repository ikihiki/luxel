...
public static class LearnUi
{
    ...
    public static StoryResult Trees(StoryContext ctx) => $"""
        ...
        Controlの具体例は[Button overview](story:Controls/Button/Overview)で確認できます。
    ...
    public static StoryResult Diagnostics(StoryContext ctx) => $"""
        ...
        次は実際のControlを[Controls](story:Controls/Button/Overview)で確認するか、[Framework](story:Learn/Framework/Overview)でアプリケーションの実行ループへ進んでください。
        """;
}
