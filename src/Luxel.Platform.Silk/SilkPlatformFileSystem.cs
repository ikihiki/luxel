...
/// <summary>System.IO を使う Silk desktop 用 rooted file system。</summary>
public sealed class SilkPlatformFileSystem : IPlatformFileSystem, IDisposable
{
    private readonly string _root;
    private readonly List<FileSystemWatcher> _watchers = [];

    public SilkPlatformFileSystem(string root) => _root = Path.GetFullPath(root);
    ...
    private sealed class WatchToken(SilkPlatformFileSystem owner, FileSystemWatcher watcher) : IDisposable
    {
...
internal static class SilkPlatformFileSystemRegistration
{
#pragma warning disable CA2255 // Desktop integration assembly intentionally registers its platform factory at load time.
    ...
    internal static void Register() =>
        PlatformFileSystems.RegisterPhysicalFactory(static root => new SilkPlatformFileSystem(root));
