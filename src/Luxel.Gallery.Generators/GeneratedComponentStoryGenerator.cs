...
public sealed class GeneratedComponentStoryGenerator : IIncrementalGenerator
{
        ...
        string assemblyName, string factoryDefault)
    {
        ...
        foreach (WidgetModel? model in models)
            if (model is not null && seen.Add(model.TypeFq)) list.Add(model);
        ...
        EmitComponentStories(source, list, assemblyName, factoryDefault);
    ...
    private static void EmitComponentStories(StringBuilder sb, List<WidgetModel> list, string assemblyName, string factoryDefault)
    {
        ...
        sb.AppendLine("        ];");
        sb.AppendLine();
        sb.AppendLine("        public static void Register(global::Luxel.Gallery.StoryCatalogBuilder builder, string runtimeBundleId)");
        sb.AppendLine("        {");
