...
public static partial class DocsAdr
{
    ...
    public static Widget Overview(StoryContext ctx) => DocNew(ctx, $$"""
        ...
        - [ADR-0009 — ノードエディタは汎用の Transaction ベース新スタックとして作る](story:ADR/0009-Node-Editor-Stack) — **Accepted** (2026-07-08)
        - [ADR-0010 — 複数エディタを束ねる Workbench フレームワークを新規に作る](story:ADR/0010-Workbench-Framework) — **Accepted** (2026-07-09)
        - [ADR-0011 — PointerEvent にボタンと修飾キーを通す](story:ADR/0011-Pointer-Button-Modifiers) — **Accepted** (2026-07-09)
        - [ADR-0012 — Markdown/リッチ文書はテキスト新スタックの構成として実装する](story:ADR/0012-Rich-Document-Stack) — **Accepted** (2026-07-09)
        ...
        - [ADR-0017 — プレイインエディタは「都度コンパイル + 停止で破棄」の別インスタンスで動かす](story:ADR/0017-Play-In-Editor) — **Accepted** (2026-07-11)
        - [ADR-0018 — ゲームの挙動は csx ビヘイビア (状態レス Update) で書く](story:ADR/0018-Csx-Behaviour-Model) — **Accepted** (2026-07-11)
