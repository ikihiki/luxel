...
public static class DocsUi
{
    ...
    public static Widget Controls(StoryContext ctx) => DocNew(ctx, $$"""
        ...
        - **テキスト**: [TextField](story:Controls/TextField/Basic) / [TextEditorView](story:Controls/TextEditorView/Basic) / [SearchField](story:Controls/SearchField/Basic) / [RichTextEditor](story:Controls/RichTextEditor/Basic) / [MarkdownEditor (hybrid)](story:Controls/MarkdownEditor/Hybrid) / [RichText 表示](story:Controls/RichText/Basic)
