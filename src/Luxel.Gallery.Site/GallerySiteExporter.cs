...
public static partial class GallerySiteExporter
{
        ...
        string location)
    {
        ...
        return $"<section class=\"runtime-story{modifier}\" data-runtime-kind=\"{H(bundle.BundleId)}\" data-luxel-runtime-location=\"{H(location)}\" data-luxel-runtime-story=\"{H(story.Path)}\" data-luxel-runtime-instance=\"{instance}\" data-luxel-runtime-args=\"{H(argsJson)}\" data-luxel-runtime-schema=\"{H(JsonSerializer.Serialize(schema, Json))}\" data-luxel-runtime-revision=\"0\"><div class=\"runtime-frame\"><iframe src=\"{url}\" data-luxel-runtime-story=\"{H(story.Path)}\" data-luxel-runtime-instance=\"{instance}\" title=\"{H(title)}\" loading=\"eager\" allow=\"webgpu; clipboard-read; clipboard-write\"></iframe></div>{ArgsTable(story, schema, seeded, instance)}<p class=\"runtime-status\" role=\"status\" aria-live=\"polite\">Loading interactive story…</p></section>";
    }
