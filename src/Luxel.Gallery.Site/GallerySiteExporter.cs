...
#review-panel{display:none;position:sticky;top:0;height:100vh;height:100dvh;overflow:hidden;padding:16px max(14px,env(safe-area-inset-right)) max(14px,env(safe-area-inset-bottom)) 14px;border-left:1px solid var(--line);background:var(--panel);z-index:15}body.review-open #review-panel{display:flex;flex-direction:column}body.review-open #review-toggle{display:none}.review-header{flex:none;margin-bottom:8px}.review-actions{display:grid;grid-template-columns:repeat(8,minmax(36px,1fr));gap:5px}.icon-button{display:flex;align-items:center;justify-content:center;min-width:0;min-height:40px;padding:0;font-size:20px;line-height:1;background:transparent}.icon-button:hover,.icon-button:focus-visible{background:var(--active)}.button-label{cursor:pointer}.review-context{min-width:0;margin-bottom:6px}.review-story{margin:0;font-size:12px;font-weight:650;line-height:1.3;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.review-url{display:block;margin-top:1px;color:var(--link);font-size:11px;line-height:1.3}.visually-hidden{position:absolute!important;width:1px!important;height:1px!important;padding:0!important;margin:-1px!important;overflow:hidden!important;clip:rect(0,0,0,0)!important;white-space:nowrap!important;border:0!important}#review-status,#review-comment{width:100%}#review-status{min-height:36px;padding:4px 9px;font-size:13px}.review-comment-label{display:block;margin:5px 0 2px;color:var(--muted);font-size:11px;font-weight:650;line-height:1.2}#review-comment{flex:1 1 160px;min-height:80px;padding:10px;resize:none;color:inherit;background:var(--bg);border:1px solid var(--line);border-radius:8px}.review-save-state,.review-privacy{margin:4px 0 0;color:var(--muted);font-size:11px;line-height:1.3}.review-privacy{margin-bottom:0}.review-save-state.error{color:var(--danger)}#review-import{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)}.review-export-fallback{width:100%;min-height:100px;margin-top:6px;background:var(--bg);color:inherit}.review-export-fallback[hidden]{display:none}
...
@media(max-width:820px),(orientation:portrait) and (max-width:1024px){body,body.review-open,body.sidebar-collapsed,body.sidebar-collapsed.review-open{display:block}main{padding:64px 18px 96px}body.review-open main{padding-bottom:calc(min(52dvh,420px) + 32px)}#review-panel{position:fixed;left:0;right:0;bottom:var(--keyboard-inset,0px);top:auto;width:100%;height:min(52vh,420px);height:min(52dvh,420px);max-height:calc(var(--visual-viewport-height,100dvh) - 12px);border-left:0;border-top:1px solid var(--line);border-radius:14px 14px 0 0;box-shadow:0 -8px 24px #0008;padding:8px max(10px,env(safe-area-inset-right)) max(8px,env(safe-area-inset-bottom)) max(10px,env(safe-area-inset-left))}.review-actions{grid-template-columns:repeat(8,minmax(32px,1fr));gap:4px}.icon-button{min-height:36px;font-size:18px}.review-context{margin-bottom:3px}.review-url,.review-privacy{display:none}#review-status{min-height:32px}.review-comment-label{margin-top:3px}#review-comment{min-height:58px}.review-save-state{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}body.review-keyboard #review-panel{height:min(42vh,280px);height:min(calc(var(--visual-viewport-height,100dvh)*.46),280px)}body.review-keyboard main{padding-bottom:calc(min(42dvh,280px) + 24px)}}
@media(max-width:520px){.review-actions{grid-template-columns:repeat(8,minmax(30px,1fr))}.icon-button{min-height:34px;font-size:17px}}
