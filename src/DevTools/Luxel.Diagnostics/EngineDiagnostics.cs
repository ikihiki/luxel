...
public static class EngineDiagnostics
{
    ...
    public const string WebGpu = "Luxel.WebGpu";         // payload: DiagWebGpu (最新のみ/browser adapter/device/surface 状態)
    ...
    public const string Custom = "Luxel.Custom";            // payload: DiagCustom (DevStats key-value)
