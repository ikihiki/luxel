...
public static class LearnResources
{
    ...
    public static StoryResult Overview(StoryContext ctx) => Page("Learn/Resources/Overview", "Resources学習ガイド", """
    ...
    public static StoryResult BuilderAndComposition(StoryContext ctx) => Page("Learn/Resources/BuilderAndComposition", "Builderとcomposition", """
    ...
    public static StoryResult ExecutionDomains(StoryContext ctx) => Page("Learn/Resources/ExecutionDomains", "Execution domain", """
    ...
    public static StoryResult ResourceManagers(StoryContext ctx) => Page("Learn/Resources/ResourceManagers", "Resource manager", """
    ...
    public static StoryResult IdentityAndHandles(StoryContext ctx) => Page("Learn/Resources/IdentityAndHandles", "Identityとhandle", """
    ...
    public static StoryResult SourcesAndSteps(StoryContext ctx) => Page("Learn/Resources/SourcesAndSteps", "SourceとStep", """
    ...
    public static StoryResult DependenciesAndPublication(StoryContext ctx) => Page("Learn/Resources/DependenciesAndPublication", "依存関係とpublication", """
    ...
    public static StoryResult OwnershipAndRetirement(StoryContext ctx) => Page("Learn/Resources/OwnershipAndRetirement", "Ownershipとretirement", """
    ...
    public static StoryResult ReloadAndRecovery(StoryContext ctx) => Page("Learn/Resources/ReloadAndRecovery", "Reloadとrecovery", """
    ...
    public static StoryResult DiagnosticsAndMetrics(StoryContext ctx) => Page("Learn/Resources/DiagnosticsAndMetrics", "Diagnosticsとmetrics", """
    ...
    public static StoryResult WasmExecution(StoryContext ctx) => Page("Learn/Resources/WasmExecution", "WASM execution", """
    ...
    private static StoryResult Page(string route, string title, string body) => ResourceLearnExamples.Attach(route, $$"""
        ...
        {{ResourceCourseCatalog.Meta(route, "中級", "Native / Browser / Headless", "ResourceSystemBuilder", "前章")}}
