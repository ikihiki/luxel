...
public static class LearnRenderingTwoD
{
    ...
    [Story("Learn/Grapics/2D/Paths", Order = 10)]
    ...
    [Story("Learn/Grapics/2D/Compositing", Order = 11)]
    ...
    [Story("Learn/Grapics/2D/Images", Order = 12)]
    ...
    [Story("Learn/Grapics/2D/Camera", Order = 13)]
    ...
    [Story("Learn/Grapics/2D/Backends", Order = 14)]
    ...
    [Story("Learn/Grapics/2D/RetainedCanvas", Order = 15)]
    ...
    [Story("Learn/Grapics/2D/IncrementalUpdates", Order = 16)]
