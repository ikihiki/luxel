...
| # | ファイル | タスク | 規模感 | リスク |
|---|---|---|---|---|
| 27 | [27-game-editor.md](27-game-editor.md) | ゲームエディタ「Luxel Studio」: プロジェクト → シーン編集 → csx → プレイインエディタ → 出荷をエディタだけで完走 (ADR-0015〜0018 予定、GE-0〜GE-7 の大プログラム。計画のみ・未着手) | **特大** | 中〜高 |
