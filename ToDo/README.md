...
| # | ファイル | タスク | 規模感 | リスク |
|---|---|---|---|---|
| 27 | [27-game-editor.md](27-game-editor.md) | ゲームエディタ「Luxel Studio」(ADR-0015〜0018 全 Accepted)。**M11 = 2D フェーズ完了 (2026-07-12)**: 編集 → プレイ → csx → 出荷の縦串 + dogfood + Docs/Studio。残 = **M12 = 3D フェーズ** (GE-8〜10: 3D アダプタ/コンパイラバックエンド/混在 dogfood + Studio シェル起票判断) | 大 | 中 |
