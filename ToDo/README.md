...
| 25 | [25-node-editor.md](25-node-editor.md) | 汎用ノードエディタ (ノード/ポート/接続線を編集。Transaction ベース新スタック = テキスト新スタックの鏡写し。`Luxel.NodeGraph` + `NodeGraphView`、S1〜S7。ADR-0009 Accepted) | **大** | 中 |
