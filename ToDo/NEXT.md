...
- [ ] **Q08**: [18 スプライトアトラス + タイルマップ](18-sprite-atlas-tilemap.md) — 大きい。MD の作業ステップ単位で複数セッションに分けて良い (分けた場合は着手中メモに進捗を書く) (着手中: 2026-07-06 — **ステップ 1-2 (スプライトアトラス) 完了**。プリミティブに srcX/srcY 追加でアトラス任意サブ矩形のサンプリング対応、SpriteAtlas/SpriteRect/SpriteAnimation/DrawSprite + SpriteAtlasStep、単体テスト 15、デモ Demos/TwoD/Sprites (vk golden) + Docs。**残り: ステップ 3 TileMap データ + チャンク描画 + 可視チャンク / ステップ 4 衝突 QueryAabb・Sweep / (余力) ステップ 5 Tiled import / ステップ 6 Docs 追記**。詳細は 18 MD 進捗節)
